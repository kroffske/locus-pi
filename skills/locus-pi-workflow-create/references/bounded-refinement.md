...
Primitives: agent, choice, literal bounded for, publishArtifact, publishPrimaryArtifact, log, awaitOperator. Whole-value carry is allowed only by the canonical bounded-loop provenance rules in [source contract](../../../extensions/workflows/references/source-shape.md#bounded-carry-and-author-owned-records). Raw schema/validate remain advanced compatibility.
