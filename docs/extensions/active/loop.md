...
- State: `.locus/runtime/goal/state.json`, `.locus/runtime/goal/continue.md`, `.pi/locus-pi/workflows/<runId>/runtime/journal.ndjson`, `.pi/locus-pi/workflows/<runId>/runtime/result.json`, `.locus/runtime/loop/workflow/*.json`
