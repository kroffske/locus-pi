...
| Shipped skills agents load to use workflows                | [../skills/locus-pi-run-workflow/SKILL.md](../skills/locus-pi-run-workflow/SKILL.md), [../skills/workflow-locus-pi/SKILL.md](../skills/workflow-locus-pi/SKILL.md), and [../skills/locus-task-workflow/SKILL.md](../skills/locus-task-workflow/SKILL.md), declared by `package.json#pi.skills`. |
