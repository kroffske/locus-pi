...
| --------------------- | --------------------------------- | ------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------- | -------- | ----------------------------------------------------------------------------------------- |
| `agents`              | `spawn_agent`                     | `agent list`, `agent inspect`, `agent run`, `agent observe`, `agent summary`, `agent drill`, `agent ps`, `ps` | `session_start`, `before_agent_start`                                            | high     | [`extensions/agents/README.md`](../extensions/agents/README.md)                           |
...
| `loop`                | `loop`                            | `loop`                                                                                                        | `agent_settled`                                                                  | medium   | [`extensions/loop/README.md`](../extensions/loop/README.md)                               |
| `model`               | —                                 | `model-roles`, `effort`                                                                                       | `session_start`                                                                  | medium   | [`extensions/model/README.md`](../extensions/model/README.md)                             |
| `plan`                | `goal`                            | `plan`, `mode`, `goal`, `goal-ai`, `review`, `todos`                                                          | `session_start`, `before_agent_start`                                            | high     | [`extensions/plan/README.md`](../extensions/plan/README.md)                               |
| `security-gate`       | —                                 | `security-audit`                                                                                              | `tool_call`                                                                      | critical | [`extensions/security-gate/README.md`](../extensions/security-gate/README.md)             |
...
| `todo-context`        | `todo_read`, `todo_write`         | `todo`                                                                                                        | `agent_settled`                                                                  | high     | [`extensions/todo-context/README.md`](../extensions/todo-context/README.md)               |
