...
- `ask-user-question`, `ast-structural-edit`, `devext-doctor`, `model`, `plan`,
  `security-gate`, `todo-context`, and `workflows`: no direct feature imports.
