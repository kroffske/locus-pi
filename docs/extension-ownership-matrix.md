...
| `workflows`           | active | Locus          | Reviewed JavaScript executes with full Node.js host access. Twelve Package workflow names are curated; eight names form the modular post-code-review bundle, while project/user sources remain trusted local code. |
