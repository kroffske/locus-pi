...
| `workflows`           | active | Locus          | Reviewed JavaScript executes with full Node.js host access. Sixteen Package workflow names are curated; eight form modular post-code-review and four form workflow-creator, while project/user sources remain trusted local code. |
