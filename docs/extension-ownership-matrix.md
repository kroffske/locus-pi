...
| `workflows`           | active | Locus          | Reviewed JavaScript executes with full Node.js host access. Only twelve Package workflow names are curated; six names form the modular post-code-review bundle, while project/user sources remain trusted local code. |
