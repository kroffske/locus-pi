...
| `workflows`           | active | Locus          | Reviewed JavaScript executes with full Node.js host access. Only thirteen Package workflow names are curated; seven names form the modular post-code-review bundle, while project/user sources remain trusted local code. |
