...
const SHARED_LAYER_MEMBERS: Record<SharedLayer, readonly string[]> = {
  host: ["pi-api", "error-text", "files", "validation", "redaction", "render-profile", "render-scheduler", "safe-output"],
  operator: [
    "command-ui",
    "widget-render",
    "operator-ui",
...
const FEATURE_DESTINATIONS: Record<string, string> = {
  ...
  "extension-inventory": "extensions/devext-doctor/extension-inventory.ts",
