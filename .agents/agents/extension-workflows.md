...
description: Run trusted workflows, orchestration commands, workflow DSL, and shipped workflows.
model: task
---
...
operator handoffs without inventing results. Respect workflow trust boundaries,
read-only checks, cancellation, replay, and explicit continuation semantics.
Never claim that a workflow ran, changed files, or completed unless the runtime
