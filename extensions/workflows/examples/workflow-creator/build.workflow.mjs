...
From the verified live project root, call workflow_check_source separately for every exact project-relative generated source path. Assess every file with the repository's authoritative source-identity implementation. Import every module without calling its default export; require the exact Design-declared meta.name, meta.profile "standard", and one default function. Compare every source with the accepted Design and SVG: entries, nodes, roles, order, handoffs, choices, bounds, failure exits, artifact paths, and no-execution boundary must correspond. Treat an unavailable tool or failed or skipped check as blocking.
...
Reopen workflow.design.md, workflow.svg, workflow-package.md, and every generated source from the injected shared workflow workspace. Reopen the authoritative live authoring contract and relevant repository source. Do not trust the builder's checks or summary: call workflow_check_source on every exact project-relative source path, independently assess source identity, import every module without executing its default export, verify exact meta identities and standard profile, compare the complete source set and graph with Design and SVG, and inspect Git state for tracked-project mutation. Confirm the generated target workflow was never executed. Do not edit files or run any generated workflow.
...
Call workflow_check_source again on every exact project-relative source path, then rerun authoritative identity assessment, module imports without default-export calls, exact meta/profile checks, and Design/source/SVG correspondence. Return the same complete corrected workflow-package.md text, including exact new evidence and honest remaining blockers.`,
