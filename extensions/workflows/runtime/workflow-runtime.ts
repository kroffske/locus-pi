 ...
 * `workflow_return` receipt — is `workflow-agent-output.ts`, composed the same way.
 *
...
import { assertSupportedAgentSchema } from "./workflow-schema.js";
...
import { assertNoRemovedAgentOptions, createWorkflowAgentOutput } from "./workflow-agent-output.js";
