...
`locus-pi` is a Pi extension package for agentic software-development workflows. It installs default extensions, curated workflows, an agent catalog, and workflow skills.
