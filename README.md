...
Start a fresh Pi session in a trusted project, then inspect the live workflow catalog:
...
That list currently activates ten extensions.
...
| `workflows`           | `/workflows`, `workflow`, source checker, optional Fusion | [README](extensions/workflows/README.md)           |
